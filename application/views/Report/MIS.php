...
$this->Table->Panel_R1('MIS','Report'); ?>
<input type="hidden" id="RepName" name="RepName" value="Rep_ReceiptMis"  />
<input type="hidden" id="Rfld" name="Rfld" value="Fdate,Tdate,Branch_Id"  />
<input type="hidden" id="SCLM" name="SCLM" value="`4`5``6`7`8`9`10`11`"  />
