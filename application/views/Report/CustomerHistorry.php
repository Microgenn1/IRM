...
$this->Table->Panel_R1('CustomerHistorry ','Report'); ?>
<input type="hidden" id="RepName" name="RepName" value="Rep_CustomerBooking"  />
<input type="hidden" id="Rfld" name="Rfld" value="Fdate,Tdate,Ledger_Id"  />
<input type="hidden" id="SCLM" name="SCLM" value="`3`"  />
      ...
      <div class="col-xs-12">
        ...
        <thead>
          ...
          <tr>
            ...
            <td><a class="btn btn-info btn-sm" onclick="Repp(this)" scs="<?php echo scs_url ?>index.php/Report/Rep" >Get</a>&nbsp; &nbsp;</td>
          </tr>
        </table>
      </div>
    </div>
...
function Repp(ee)
{
	if($("#Ledger_Id").val()==0 || $("#Ledger_Id").val()=="0")
	{
	}
	else
	{
