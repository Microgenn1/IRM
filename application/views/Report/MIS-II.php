...
<input type="hidden" id="RepName" name="RepName" value="MISII"  />
<input type="hidden" id="Rfld" name="Rfld" value="Fdate,Tdate,Code"  />
<input type="hidden" id="SCLM" name="SCLM" value="`2`3`4"  />
      ...
      <div class="col-xs-12">
        ...
        <thead>
          ...
          <tr>
            ...
            <td width="24%"><input type="text" id="Code" name="Code" class=""  /></td>
