    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="22%" align="center"><strong>INVOICE</strong></td>
          </tr>
          <tr>
            ...
            <td align="left" valign="middle">&nbsp;&nbsp;NO : <?php echo $row->PONO ?></td>
          </tr>
          <tr>
            ...
            <td align="left" valign="middle">&nbsp;&nbsp;DATE  : <?php echo $row->PODATE ?></td>
          </tr>
        </table></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:11px">
        ...
        <tr>
          ...
          <tr>
            <td width="52%" rowspan="2"  style="border-right:1px solid #000">&nbsp;</td>
          </tr>
          <tr>
            <td width="48%"><table width="98%" border="0" align="right" style="font-size:11px">
                <tr>
    ...
    <tr>
      <td><table width="100%" border="0" cellpadding="3" cellspacing="0" style="border-top:1px solid #000;border-bottom:1px solid #000;font-size:11px" >
		 ...
		 foreach($res->result_array() as $rw)
		 {
		  ...
		  foreach($sres->result_array() as $rw)
		 {
			    $TABLE = $TABLE . "<tr>";
                $TABLE = $TABLE . "  <td style='border-right:0px solid #000' align='left'>&nbsp;" .$cou. "</td>";
                $TABLE = $TABLE . " <td align='center' valign='left'> </td>";
                $TABLE = $TABLE . " <td align='center' valign='left'>  </td>";
                $TABLE = $TABLE . " <td  align='left'>" .$rw["dec"]. " </td>";
                $TABLE = $TABLE . " <td  align='RIGHT'>" .$rw["AMT"]. "&nbsp;&nbsp;</td>";
                $TABLE = $TABLE . "</tr>";
			    $cou++;
				$tamtt = $tamtt+$rw["AMT"];
		 }
		  echo $TABLE;
		 $NUM=$this->db->query("SELECT dbo.NumToWords(".$tamtt.",'Y')[NUM]")->row();
		 ?>
          <tr>
          ...
          <tr>
            <td colspan="4" align="left" valign="middle">&nbsp;&nbsp;TRANSPORT CHARGES ONLY</td>
            <td align="center" valign="middle">&nbsp;</td>
          </tr>
          <tr>
            <td colspan="4" align="left" valign="middle">&nbsp;&nbsp;SERVICE TAX PAYABLE IS YOUR RESPONSIBILITY</td>
            <td align="center" valign="middle">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td width="53%" align="right" valign="middle" style="border-top:1px solid #000;" ><strong>Total Amount</strong></td>
            <td width="14%" align="right" valign="middle" style="border-top:1px solid #000;" ><strong><?php echo $tamtt.".00";?>&nbsp;&nbsp;</strong></td>
          </tr>
      </table></td>
    </tr>
    <tr>
