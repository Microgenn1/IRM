...
{
	$amt = $row['Transaction_Amount']/100;
	echo '<tr>';
	echo '<td>'. $cou.'</td>';
	echo '<td>'.$row['Merchant_Refno'].'</td>';
	echo '<td>'.$amt.'</td>';
	echo '<td>'.$row['Transaction_Code_Description'].'</td>';
	echo '<td><b>Receipt No :</b> '.$row['Receiptno'].'<br><b>Transaction No :</b> '.$row['Transactionno'].'<br><b>Card Type :</b> '.$row['CardType'].'</td>';
	echo '</tr>';
	 $cou++;
}
