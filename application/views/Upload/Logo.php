...
<div class="fram" >
	...
	<div id="selectImage">
        ...
        <input type="hidden" id="lk" name="lk" value="<?php echo base64_encode('Logo');?>"  />
        <input type="hidden" id="id" name="id" value="hotellogo_<?php echo $_SESSION['Hotel_Id'];?>"  />
		<?php echo "<input type='submit' name='submit' value='Upload' class='submit'/> ";?>
	</div>
<?php echo "</form>"?>

<img height="300" width="300" class="img-thumbnail" src="<?php echo scs_url."uploads/hotellogo_".$_SESSION['Hotel_Id'].".jpg"; ?>" ?>
