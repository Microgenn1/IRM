...
$this->Table->Panel_S1('Consignee','Master'); ?>

<input type="hidden" id="HtmlForm" name="HtmlForm" value="PRO_Mas_Consignee"  />
<input type="hidden" id="Consignee_Id" name="Consignee_Id"  />
<input type="hidden" id="TableName" name="TableName" value="Mas_Consignee"  />
<input     type="hidden" name="CCODE" id="CCODE" value="12"   val="1" num="0" isn="1" ln="30" ty="V" maxlength="30" >
<div class="fram" >
<div class="form-group">
  <div class="row">
    <div class="col-xs-5">
      <label class="text-yellow" >Consignee</label>
      <input   class="form-control" type="text" name="Consignee" id="Consignee"   val="1" num="0" isn="1" ln="300" ty="V" maxlength="300" >
    </div>
  </div>
</div>
<div class="form-group">
...
<div class="row">
  <div class="col-xs-5">
    ...
    <input   class="form-control" type="text" name="CITY" id="CITY"   val="0" num="0" isn="1" ln="300" ty="V" maxlength="300" >
  </div>
</div>
</div>
<div class="form-group">
...
<div class="form-group">
  <div class="row">
    <div class="col-xs-5">
      <button type="button" class="btn btn-info"  scs="<?php echo @NET ?>" onclick="eva_(this)" type="button" id="BUTS" value="Save" name="BUT" idn="Consignee_Id"    >
      SAVE
      </button>
    </div>
  </div>
